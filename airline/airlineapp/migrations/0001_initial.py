    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_seats', models.IntegerField(default='unspecified', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Airport',
            fields=[
                ...
                ('country', models.CharField(default='unspecified', max_length=50)),
                ('time_zone', models.CharField(default='unspecified', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('number_booked', models.IntegerField(default='unspecified', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.CharField(default='unspecified', max_length=10)),
                ...
                ('aircraft_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='airlineapp.Aircraft')),
            ],
        ),
        migrations.CreateModel(
            name='Invoice',
